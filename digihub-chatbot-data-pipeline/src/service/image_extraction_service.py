...
class ImageTextExtractionService:
    ...
    VISION_EXTRACTION_PROMPT = """You are an expert at extracting text and information from images.

Please analyze this image and extract ALL text and meaningful information from it.

Instructions:
1. Extract all visible text exactly as it appears
2. Describe charts, diagrams, or visual elements with relevant data
3. Preserve the layout and structure where meaningful
4. For tables, extract the data in a readable format
5. If the image contains technical diagrams, describe the components and relationships
6. If the image is empty or contains no meaningful information, return an empty response

Return only the extracted text and descriptions, without meta-commentary."""
