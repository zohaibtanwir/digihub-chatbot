...
class TestValidateChunkQuality:
    ...
    def test_only_headings_is_invalid(self):
        ...
        # Make content long enough to pass token count (50+ tokens) but only contains headings
        # Each heading needs to be verbose enough to accumulate tokens
        heading_only = """# Heading 1 - Introduction to the Comprehensive Document About Authentication Systems
## Heading 2 - Overview of Key Topics Related to Security and Access Control Systems
### Heading 3 - Detailed Subtopics Here Including User Management and Permissions
#### Heading 4 - More Detailed Information About Configuration Settings and Options
##### Heading 5 - Additional Context on Implementation Details and Best Practices
###### Heading 6 - Further Notes on Integration with External Identity Providers
"""
    ...
    def test_placeholder_content_is_invalid(self):
        """Placeholder content like 'lorem ipsum' should be invalid if under 100 tokens."""
        # Make content 50-99 tokens (placeholder check only triggers if < 100 tokens)
        # and contains placeholder text indicator
        placeholder = """Lorem ipsum dolor sit amet, consectetur adipiscing elit.
Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.
This is some additional filler text to reach the minimum token count requirement.
...
"""
    ...
    def test_valid_chunk_empty_questions_empty_embedding(self):
        ...
        # Content must be 50+ tokens to pass validation
        content = """# Valid But No Questions Generated By LLM

This content is valid and meets all the quality requirements for indexing.
However, the LLM returns no questions for it in this particular test scenario.
The system should handle this edge case gracefully and return an empty embedding vector.
Empty questions should result in an empty questionsEmbedding field in the result dictionary.
This additional text ensures we have enough tokens to pass the minimum token count validation.
The validation requires at least fifty tokens for a chunk to be considered valid content.
"""
