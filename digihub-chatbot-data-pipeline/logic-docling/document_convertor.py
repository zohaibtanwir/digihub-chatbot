...
class DocumentConverterService:
    ...
    def _get_pipeline_options_for_pptx_as_pdf(self) -> PdfPipelineOptions:
        ...
        """
        pipeline_options = PdfPipelineOptions(artifacts_path=r"D:\Repos\AI RFP\docling_v2" )
    ...
    def _initialize(self):
        # Initialize with default options - will be overridden dynamically for PPTX
        pass

    def get_document_converter(self, is_pptx_as_pdf: bool = False):
        """
